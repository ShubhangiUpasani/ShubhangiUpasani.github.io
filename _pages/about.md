...
I believe the most impactful AI research is the kind that survives contact with production. That's why I'm drawn to problems where new algorithms must prove themselves under real workloads—not just on benchmarks. Whether developing more efficient inference techniques, advancing post-training methods, or building reliable agentic systems, I'm motivated by pushing the capabilities of frontier AI while delivering technology that people actually use.