...
My research has translated directly into production. Techniques I've developed for long-context inference power capabilities on SambaNova Cloud, serving real-world use cases while advancing the state of efficient LLM deployment. I've also authored research published at venues including ICLR, ISC, and ICDMAI, and I regularly serve as a reviewer for leading machine learning conferences. My work on Agentic Context Engineering (ACE) received widespread media coverage, earned multiple awards at ICLR 2026 workshops, and has been presented to audiences across several enterprises. Before joining SambaNova, I interned as a Software Developer at Amazon and Western Digital, experiences that laid the foundation for my work at the intersection of machine learning, systems, and software engineering.
